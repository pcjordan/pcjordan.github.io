...
Insert the following code in the `head` section of your pages:
    ...
    <link rel="mask-icon" href="/assets/favicon/safari-pinned-tab.svg" color="#3fa429">
    <link rel="shortcut icon" href="/assets/favicon/favicon.ico">
    <meta name="apple-mobile-web-app-title" content="Philip's Blog">
    <meta name="application-name" content="Philip's Blog">
